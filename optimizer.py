...
for i in range(N_trials):
	...
	v,e=es_covnet(ds, steps=50, p=4, batch_size=64, N1=10,N2=100,drop_prob=d,momentum=0.1, learning_rate=alpha, L=l)
...
np.savetxt('trials.csv',trials,header=Header)
